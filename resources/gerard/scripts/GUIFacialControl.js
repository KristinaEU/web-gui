...
this.onRenderGUI = function(){
  ...
  if (gl.mouse.x < rect.x + rect.w && gl.mouse.x > rect.x &&
    ...
    if (gl.mouse.left_button  && !this._clicked){
      ...
      if (LS.Globals.BMLManager)
        LS.Globals.BMLManager.newBlock({"blink":true, composition: comp});
      else
  ...
  if (gl.mouse.x < rect.x + rect.w && gl.mouse.x > rect.x &&
    ...
    if (gl.mouse.left_button  && !this._clicked){
      this._clicked = true;
      if (LS.Globals.BMLManager)
        LS.Globals.BMLManager.newBlock({"lg":this._lipSyncMsg, composition: comp});
      else
  ...
  if (gl.mouse.x < rect.x + rect.w && gl.mouse.x > rect.x &&
    ...
    if (gl.mouse.left_button  && !this._clicked){
      ...
      if (LS.Globals.BMLManager)
        LS.Globals.BMLManager.newBlock({"face":obj, composition: comp});
      else
      	LS.Globals.face(obj);
      gl.fillStyle = "rgba(127,255,127,0.8)";
    }
  ...
  if (gl.mouse.x < rect.x + rect.w && gl.mouse.x > rect.x &&
    ...
    if (gl.mouse.left_button && !this._clicked){
      ...
      if (LS.Globals.BMLManager)
        LS.Globals.BMLManager.newBlock({"gaze":obj, composition: comp});
      else
      	LS.Globals.gaze(obj);
  ...
  if (gl.mouse.x < rect.x + rect.w && gl.mouse.x > rect.x &&
    ...
    if (gl.mouse.left_button && !this._clicked){
      ...
      var obj = {"influence":val3, "offsetDirection":val, "offsetAngle": val2};
      if (LS.Globals.BMLManager)
        LS.Globals.BMLManager.newBlock({"gazeShift":obj, composition: comp});
      else
  ...
  if (gl.mouse.x < rect.x + rect.w && gl.mouse.x > rect.x &&
    ...
    if (gl.mouse.left_button&& !this._clicked){
      ...
      if (LS.Globals.BMLManager)
        LS.Globals.BMLManager.newBlock({"head":{"lexeme": val}, composition: comp});
      else
